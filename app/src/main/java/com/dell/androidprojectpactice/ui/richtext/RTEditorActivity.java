package com.dell.androidprojectpactice.ui.richtext;
...
import com.dell.androidprojectpactice.util.richtext.FileHelper;
...
public class RTEditorActivity extends RTEditorBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set theme
        setTheme(mUseDarkTheme ? R.style.AppTheme : R.style.RTE_BaseThemeLight);

        super.onCreate(savedInstanceState);

        // set layout
        setContentView(R.layout.ac_richtext_content);
        ...
        // register toolbar 0a (if it exists)
